...
\label{sub:fulltime}
\tlcventry{2016}{0}{Senior Software Engineer, R\&D Trading Systems}{Bloomberg LP}{New York, NY}{}{
\begin{tightitemize}
	\item Development of high performant, server-side C++ applications for the Institutional Sales Application team within Bloomberg R\&D.
	\item Responsible for developing complex view-side logic built on top of a custom Javascript graphics framework for the team.
\end{tightitemize}}
